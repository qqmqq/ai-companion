...
| **前端** | React 19 · Vite 6 · 原生 CSS（无 UI 框架依赖，配色/间距/发光全走令牌） · 界面全中文 · 二次元夜色主题 |
| **工程** | pnpm workspace（`backend` / `frontend` / `scripts`） · `node:test`（后端 469 例 / 前端 73 例） |
...
pnpm test          # 后端 469 例 + 前端 73 例（单元 / 集成 / 架构守卫）
